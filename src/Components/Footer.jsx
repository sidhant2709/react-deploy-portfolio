          ...
          <div className="col-lg-4 col-md-6 col-sm-6 address">
            <div className="d-flex">
              ...
              <p style={{ color: "white", fontSize: "1rem" }}>
                Matru Nilaya,Plot-No.-1439-1440,
                <br />
                New Forest Park,Bhubaneswar,
                <br />
                Odisha,India
                <br />
                PIN-751009
          ...
          <div className="col-lg-3 col-md-2 col-sm-6">
            <div className="row gap">
              <div className="col link-to">
                ...
                <br />
                <Link smooth={true} to="about" href="" className="footer-nav">
                  About
                </Link>
                <br />
                <Link smooth={true} to="blogs" href="" className="footer-nav">
                  Blogs
                </Link>
              </div>
              <div className="col link-to">
